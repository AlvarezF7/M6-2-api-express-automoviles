...
# Descripción
 ...
 - Endpoints REST para:
    ...
    /conductores → Listar todos los conductores.
    /automoviles → Listar todos los automóviles.
    /conductoressinauto?edad=XX → Conductores menores a edad sin automóvil.
    /solitos → Conductores sin auto y automóviles sin conductor.
    /auto → Buscar autos por patente o iniciopatente y sus conductores.
